...
//                	if(service.getContainer() instanceof StandardEngine){
//                		StandardEngine standardEngine =(StandardEngine) service.getContainer();
//                		for(Container childrenContainer :standardEngine.findChildren()){
//                			if(childrenContainer instanceof StandardHost){
//                				StandardHost standardHost = (StandardHost) childrenContainer;
